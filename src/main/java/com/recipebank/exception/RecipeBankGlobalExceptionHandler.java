...
@ControllerAdvice
public class RecipeBankGlobalExceptionHandler {

    @ExceptionHandler({SearchCriteriaInvalidException.class})
    public ResponseEntity<Object> searchCriteriaInvalidExceptionHandler(SearchCriteriaInvalidException exception) {
